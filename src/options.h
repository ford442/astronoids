#ifndef __OPTIONS_H
#define __OPTIONS_H
#define LOGICAL_WIDTH_PX 800
#define LOGICAL_HEIGHT_PX 600
...
#define TITLE_ASTRONOIDS 5
#define START_LEVEL_DELAY_MS 6200.0f
#define NEXT_WAVE_DELAY 4.2f
#define GAMEOVER_COUNTDOWN 3.3f
